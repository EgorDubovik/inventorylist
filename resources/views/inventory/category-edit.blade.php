                        ...
                        <div class="card-body">
                            ...
                            <form method="post">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input type="address" class="form-control" id="inputEmail3" placeholder="Customer address" name="customer_address" value="{{$category->customer_address}}">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-warning btn-block">Save information</button>
                            </form>
                        </div>
                    </div>
                </div>
